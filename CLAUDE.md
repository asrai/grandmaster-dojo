...
- **Domain vocabulary that collides with platform API names**: `style` (a 무공 초식 object) · `window` (the counter-window phase). Extend this list whenever another collision is found.
